...
class Viewer(pyglet.window.Window):
    ...
    def __init__(self, arm_info, goal):
        ...
        super(Viewer, self).__init__(width=400, height=400, resizable=False, caption='Robot Arm Simulator', vsync=False)
        # pyglet.gl.glClearColor(1, 1, 1, 1)
        pyglet.gl.glClearColor(0.1, 0.15, 0.2, 1)
        ...
        self.arm1 = self.batch.add(
            ...
            ('v2f', [250, 250,                # location
                     ...
                     260, 300,
                     260, 250]),
            ('c3B', (210, 210, 210) * 4,))  # color
        self.arm2 = self.batch.add(
            4, pyglet.gl.GL_QUADS, None,
            ('v2f', [100, 150,              # location
                     100, 160,
                     200, 160,
                     200, 150]), ('c3B', (210, 210, 210) * 4,))
